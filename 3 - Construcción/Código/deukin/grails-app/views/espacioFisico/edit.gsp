...
<title><g:message code="espaciosFisicos.edit.label" /></title>
...
<body>
	...
	<div id="edit-espacioFisico"
		class="content scaffold-edit" role="main">
		<h1>
			<g:message code="espaciosFisicos.edit.label" />
		</h1>
		<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
		</g:if>
		<g:hasErrors bean="${espacioFisicoInstance}">
			<ul class="alert alert-danger" role="alert">
				<g:eachError bean="${espacioFisicoInstance}" var="error">
					<li
			...
			<div class="col-lg-12 col-md-12 col-sx-12 lista-propiedades">
				<div class="well">
					<g:form method="post"
						...
						<g:hiddenField name="version" value="${espacioFisicoInstance?.version}" />
						<fieldset class="form">
