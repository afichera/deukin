			...
			<ol class="property-list alumno">
				...
				<li class="fieldcontain">
					<span id="fotoPerfil-label" class="property-label"><g:message code="alumno.fotoPerfil.label" default="Foto Perfil" /></span>
						...
						<span class="property-value" aria-labelledby="fotoPerfil-label"><g:link controller="fotoPerfil" action="show" id="${alumnoInstance?.fotoPerfil?.id}">${alumnoInstance?.fotoPerfil?.encodeAsHTML()}</g:link></span>
