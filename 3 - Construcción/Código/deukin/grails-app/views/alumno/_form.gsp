...
<div class="fieldcontain ${hasErrors(bean: alumnoInstance, field: 'fotoPerfil', 'error')} ">
	...
	<g:select id="fotoPerfil" name="fotoPerfil.id" from="${com.deukin.FotoPerfil.list()}" optionKey="id" value="${alumnoInstance?.fotoPerfil?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
