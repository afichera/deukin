...
@Mock([UsuarioRegistro, InscripcionInstitucion, Documento, Alumno, Persona, Contacto, Telefono, Usuario, Rol])
...
//		inscripcionInstitucion.usuarioRegistro = inscripcionInstitucion.usuarioRegistro.save(failOnError:true)
